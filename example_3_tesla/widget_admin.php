...
/**
 * widget_admin.php
 * Admin interface for the Tesla Digital Clone Widget
...
$adminPassword = 'tesla_admin_2024';
...
<head>
    ...
    <title>Tesla Widget Admin - Inventions & Knowledgebase</title>
    <style>
...
<body>
    <div class="container">
        <h1>🤖 Tesla Widget Admin - Inventions & Knowledgebase</h1>
        ...
        <div class="card">
            ...
            <form id="uploadForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="docName" name="docName" placeholder="e.g., alternating_current_whitepaper">
                </div>
        ...
        <div class="card">
            ...
            <form id="textForm">
                <div class="form-group">
                    ...
                    <input type="text" id="textTitle" name="textTitle" placeholder="e.g., wardenclyffe_project">
                </div>
                <div class="form-group">
